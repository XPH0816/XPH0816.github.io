...
title: "项目"
links:
  - title: GitHub Action 用于 WebDAV 部署
    description: 使用 WebDAV 部署的 GitHub Action
    website: https://github.com/XPH0816/webdav-deploy-action
    image: /icons/upload.svg
  - title: C语言 音乐播放器 (CLI)
    description: 一个C语言写的音乐播放器为了数据结构与算法课程设计
    website: https://github.com/XPH0816/DSA-Project
    image: /icons/netease-music.svg
  - title: 算法演示幻灯片 (Slidev)
    description: 一个使用 Slidev 制作的算法演示 PPT
...
- [GitHub Action 用于 WebDAV 部署](https://github.com/XPH0816/webdav-deploy-action) 

- [音乐播放器 (CLI)](https://github.com/XPH0816/DSA-Project)
...
[更多项目请访问我的 GitHub 仓库](https://github.com/XPH0816?tab=repositories)